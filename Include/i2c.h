...
typedef enum {IDLE, READING, READ_COMPLETE, WRITING, WRITE_COMPLETE, 
	WAIT_1, WAIT_2, WAIT_3, WAIT_4, REPEAT_START, RECEIVE, SEND_REGISTER, 
	CHECK_READ, CHECK_READ_2, LAST_READ} I2C_STATUS_T;
typedef enum {NONE, READ, WRITE} I2C_COMMAND_T;
...
// New states defined for Task_Motion_Sensor_FSM
